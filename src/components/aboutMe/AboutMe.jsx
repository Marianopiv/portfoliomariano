    ...
    <div className="section-block reveal bg-black text-white pl-4 lg:pl-24">
      ...
      <div className="flex flex-col items-center justify-center mt-4 xl:pr-14 2xl:pr-20 ">
        <div className="flex gap-4 flex-wrap relative  md:hidden">
          ...
          <div className="timeline-line timeline-line--vertical absolute border-2 opacity-80 h-96  left-14 sm:left-custom"></div>
          <div className="timeline-line timeline-line--cap absolute border-2 opacity-80 h-2 top-96  left-14 sm:left-custom"></div>
        </div>
        <div className="hidden gap-4 relative md:flex">
          {fullSobreMi === null
            ? Array.from({ length: 5 }).map((_, index) => (
                ...
                >
                  <div className="skeleton-line skeleton-line--year"></div>
                  <div className="timeline-line timeline-line--horizontal absolute border-2 opacity-80 w-custom top-8 w-customlg  left-24"></div>
                  <div className="item-point w-3 z-20 "></div>
                  <div className="skeleton-line skeleton-line--story"></div>
                </div>
              ))
